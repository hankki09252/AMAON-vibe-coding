...
import type { WeeklyPlayerOption } from "./weekly-admin";
...
export default function CommunityBoard({ signedIn = false, weeklyPlayerOptions = [] }: { signedIn?: boolean; weeklyPlayerOptions?: WeeklyPlayerOption[] }) {
